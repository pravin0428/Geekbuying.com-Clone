...
function Navbar() {
 ...
 console.log(isAuth , nameDis)
  return (
    ...
    h='200px'
    bgGradient={[
      'linear(to-tr, blue, blue)',
      'linear(to-tl, blue, blue)',
      'linear(to-b, white, blue)',
    ]}
    >
      {/* 1st line_navbar */}
...
<Box className="dropdown"  
  ...
  <Link href="/">Hepl Center</Link>
    ...
    <Box w='160px' h='10'  >
   <Link to="/" ><Img src="https://gizcoupon.com/wp-content/uploads/thumbs_dir/Geekbuying-logo-1zk9ynaj8fqygsy9ixsupymlq2d10ugt7pe606kgerl0.png"    alt="logo" /></Link> 
    </Box>
